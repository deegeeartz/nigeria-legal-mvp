...
SEED_LAWYERS = [
    Lawyer(
        ...
        latitude=6.5244,
        longitude=3.3792,
        knowledge_contribution_score=45.0,
    ),
    Lawyer(
        id="lw_002",
        ...
        latitude=9.0765,
        longitude=7.3986,
        knowledge_contribution_score=80.0,
    ),
    Lawyer(
        id="lw_003",
        ...
        latitude=6.5833,
        longitude=3.3333,
        knowledge_contribution_score=20.0,
    ),
    Lawyer(
        id="lw_004",
...
SEED_TEMPLATES = [
    {
        ...
        "description": "A standard mutual NDA for protecting business secrets before a partnership discussion.",
        "category": "contracts",
        "price_ngn": 0
    },
    {
        "name": "Residential Tenancy Agreement",
        "description": "Standard Lagos State tenancy agreement for residential property leasing.",
        "category": "property",
        "price_ngn": 2500
    },
    {
        "name": "Employment Contract",
        "description": "Standard Nigerian employment agreement complying with the Labour Act.",
        "category": "employment",
        "price_ngn": 5000
    }
]
